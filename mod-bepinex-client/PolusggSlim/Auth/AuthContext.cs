...
namespace PolusggSlim.Auth
{
    public class AuthContext : IDisposable
    {
        ...
        public bool LoadFromTokenString(string tokenString)
        {
            var authModel = JsonConvert.DeserializeObject<SavedAuthModel>(
                Encoding.UTF8.GetString(Convert.FromBase64String(tokenString))
            );
        ...
        public bool LoadFromFile()
        {
            ...
            {
                LoadFromTokenString(File.ReadAllText(SaveFilePath));
            }
